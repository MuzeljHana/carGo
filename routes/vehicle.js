...
router.post('/', auth, async (req, res, next) => {
    ...
    knex.into("Vozilo")
        .insert([{
            ...
            slika: slika_name,
            maks_volumen_tovora: req.body.maks_volumen_tovora || null,
            maks_dolzina_tovora: req.body.maks_dolzina_tovora || null,
            maks_sirina_tovora: req.body.maks_sirina_tovora || null,
            maks_visina_tovora: req.body.maks_visina_tovora || null,
            maks_st_palet: req.body.maks_st_palet || null,
            idUporabnik: req.session.user_id,
            idZnamka: (qb) => {
